...
public class CardView2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRecyclerAdapter2 =new MyFirebaseRecyclerAdapter2(BloodBank.class,R.layout.fragment_card_list1,MyFirebaseRecyclerAdapter2.BloodBankViewHolder.class,childRef,getApplicationContext());
